<template><!-- 
  ...
  position: absolute;
  top: 0;
  left: 0;" @ended="onSplashEnded" @play="onSplashStarted">
      ...
      <img class="home_logo img-fluid" :src="randomImage"  />
            ...
            <div
              :style="{ backgroundImage: `url(${randomImage})`, transition: `background-image 0.5s ease-in-out`, backgroundSize: `cover` }"
...
export default {
  ...
  created() {
    ...
    if (process.client) {
      ...
      if (this.unlocked) {
        this.unlocked = sessionStorage.getItem('unlocked') === 'true';
      }
    }
  },
  mounted() {
